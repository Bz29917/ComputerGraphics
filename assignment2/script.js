...
// loader.load(
//   "/models/LightBulb.glb", // Path to the light bulb model
//   (gltf) => {
//     const lightBulb = gltf.scene;
//     lightBulb.position.copy(directionalLight.position); // Position at the light source
//     lightBulb.scale.set(0.008, 0.008, 0.008); // Adjust scale if needed
//     scene.add(lightBulb);
//   },
//   undefined,
//   (error) => {
//     console.error("Error loading light bulb model:", error);
//   }
// );
